tr -d '\r' < Bacteroides_uniformis_bins.csv > Bacteroides_uniformis_bins.csv
...
Contigs: You should already have contigs prepared. Contigs for BGI samples should be found in the designated location:
'/gpfs/space/GI/GV/Projects/Microbiome/BGIset_Mags_DB/Contigs_DB/assembly_'
Pathways: All paths (except contigs & reads fld) are set as relative, which means you can freely relocate entire folders, but it's essential to maintain the necessary input files for running the scripts.
